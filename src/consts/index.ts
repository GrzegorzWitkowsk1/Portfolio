...
export const workExperience: WorkExperienceEntryType[] = [
	...
	},
	{
		...
		position: "Junior/Mid Frontend Developer",
		...
		translations: {
			"pl-PL": {
				...
				achievements: [
					"Zbudowanie aplikacji React od podstaw na bazie poprzedniego kodu i zredukowanie ilości zbędnego kodu o ~ 40%.",
					"Utrzymywanie aplikacji przez cały cykl życia",
			...
			"en-EN": {
				...
				achievements: [
					"Built a React application from scratch based on existing code and reduced redundant code by ~40%.",
					"Maintained the application throughout its entire lifecycle.",
					"Created an admin panel for content management.",
					"Delivered browser extensions alongside the main application.",
					"Mentored junior developers and led the team.",
				],
			},
		},
	},
